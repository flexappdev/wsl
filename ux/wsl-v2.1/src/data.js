...
window.WSL_DATA = {
  ...
  /* ============================================================
     All countries — placeholder directory (UN member states + observers)
     Each entry: { name, flag, code, region }
     Countries that exist in `countries` above get rich detail pages;
     the rest render as "coming soon" placeholder cards.
     ============================================================ */
  allCountries: [
    // North Africa
